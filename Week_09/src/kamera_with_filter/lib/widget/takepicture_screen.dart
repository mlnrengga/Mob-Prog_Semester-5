...
import 'package:kamera_with_filter/screens/camera_with_filter_screen.dart';
...
class TakePictureScreenState extends State<TakePictureScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Take a picture - 2341720160')),
        ...
        onPressed: () async {
          try {
            ...
            await Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => CameraWithFilterScreen(
